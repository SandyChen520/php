					...
					<div class="cart">
						...
						<div class="item-list-wrap">
							<div class="cart-item">
								...
								<ul class="cart-item-list" v-for="items in productList">
									<li>
										...
										<div class="cart-item-pic">
											<img v-bind:src="items.productImage" />
										</div>
										<div class="cart-item-title">
											<div class="item-name" v-text="items.productName"></div>
										</div>
										<div class="item-include">
											<dl>
												<dt>赠送:</dt>
												<dd v-for="parts in items.parts" v-text="parts.partsName">	
									...
									<div class="cart-tab-2">
										<div class="item-price">{{items.productPrice | formatMoney}}</div>
									</div>
									...
									<div class="cart-tab-4">
										<div class="item-price-total">{{items.productPrice * items.productQuentity | formatMoney}}</div>
									</div>
